    ...
    <div className="space-y-8 max-w-5xl mx-auto font-sans">
      ...
      <div className="bg-gradient-to-r from-slate-900 to-slate-950 text-white rounded-3xl p-8 border border-slate-800 shadow-xl space-y-3">
        ...
        <h1 className="text-3xl font-extrabold tracking-tight">
          Psychometric Career & Personality Suite (5 Tests)
        </h1>
        <p className="text-slate-300 text-xs sm:text-sm max-w-2xl leading-relaxed">
          Your counsellor assigns 2 to 3 tests out of the 5 standardized psychometric frameworks to evaluate university program fit and career trajectory.
        </p>
      </div>
          ...
          return (
            <div key={test.key} className="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm flex flex-col justify-between space-y-4 hover:shadow-md transition">
              <div className="space-y-3">
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex flex-col items-end gap-1">
                    {assigned && (
                      <span className="px-2 py-0.5 rounded-full bg-indigo-100 text-indigo-800 text-[9px] font-extrabold uppercase tracking-wider">
                ...
                <div>
                  <span className="text-[10px] font-bold uppercase tracking-wider text-indigo-600">{test.framework}</span>
              ...
              <div className="pt-4 border-t border-slate-100">
                <Link
                  to={test.path}
                  className="w-full inline-flex items-center justify-center gap-2 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs shadow-md transition"
                >
